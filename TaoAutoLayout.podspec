...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/TaoAutoLayout"
  ...
  s.author             = { "tao6" => "tao6chn@yeah.net" }
  # Or just: s.author    = "tao6"
  # s.authors            = { "tao6" => "tao6chn@yeah.net" }
  # s.social_media_url   = "http://twitter.com/tao6"
  ...
  s.source       = { :git => "http://EXAMPLE/TaoAutoLayout.git", :tag => "#{s.version}" }
